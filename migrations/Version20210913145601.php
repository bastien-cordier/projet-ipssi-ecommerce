 ...
 */
final class Version20210913145601 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier ADD id_user_id INT NOT NULL, ADD id_product_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier DROP id_user_id, DROP id_product_id');
    }
}
